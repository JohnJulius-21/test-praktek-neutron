...
@section('container')
    ...
    <div class="card rounded" style="max-height: 750px; overflow-y: auto;">
        ...
        <div class="px-3 mb-3">
            ...
            <form action="{{ route('simpanProduk') }}" method="POST">
                @csrf
                <div class="card rounded px-4 mb-3 py-3 mt-3">
                    <div class="mb-3">
                        <label for="nama_produk" class="form-label">Nama Produk</label>
                        <input type="text" class="form-control @error('nama_produk') is-invalid @enderror" placeholder="Nama Produk" name="nama_produk">
                        @error('nama_produk')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('harga') is-invalid @enderror" placeholder="Masukan Harga" name="harga">
                        @error('harga')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('stok') is-invalid @enderror" placeholder="Masukan Stok" name="stok">
                        @error('stok')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
